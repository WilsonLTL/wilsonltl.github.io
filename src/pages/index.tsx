  ...
  return (
    <div className="flex flex-col">
      ...
      <div id="about" className="flex lg:flex-row flex-col">
        ...
        <div className="md:w-1/2 w-full flex flex-col bg-white items-center justify-center border">
          <div className="p-4 m-16 space-y-8">
            <p className="font-bold leading-loose">I am a Wilson LO, an eningeer from Hong Kong 🀄︎</p>
            <Divider />
      ...
      <div id="work" className="flex lg:flex-row flex-col">
        <div className="md:w-1/2 w-full flex flex-col bg-white items-center border justify-between">
        <span></span>
          <img className="w-52 h-52" src="/assets/work.svg"/>
          <div className="mb-8 justify-self-end">
            <Breadcrumbs className="text-black" aria-label="breadcrumb">
      ...
      <div id="contact" className="flex lg:flex-row flex-col h-screen">
        <div className="md:w-1/2 w-full flex flex-col bg-black items-center justify-between">
          <span></span>
